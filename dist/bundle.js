(() => {
  ...
  ((AST2) => {
    ...
    AST2.isNum = isNum;
    function isArray(e) {
      return e instanceof AST2.Array;
    }
    AST2.isArray = isArray;
    class Plus {
    ...
    AST2.Div = Div;
    function combining(left2, middle, right2) {
    ...
    AST2.combining = combining;
    class Call {
      constructor(target, args2) {
        this.target = target;
        this.args = args2;
      }
      evaluate(env) {
  ...
  var paren = Primitives.appfun(
    Primitives.seq(
      Primitives.between(Primitives.char("("))(Primitives.char(")"))(
        Primitives.appfun(Primitives.seq(ws)(expr))(([, e]) => e)
      )
    )(ws)
  )(([e]) => e);
  var arr = Primitives.appfun(
    Primitives.between(
      Primitives.char("[")
    )(Primitives.char("]"))(
      Primitives.seq(ws)(
        Primitives.seq(expr)(
          Primitives.many(
            Primitives.seq(Primitives.seq(ws)(Primitives.char(",")))(Primitives.seq(ws)(expr))
          )
        )
      )
    )
  )(
    ([_, [head, tail]]) => new AST.Array([
      head,
      ...tail.map((t) => t[1][1])
    ])
  );
  ...
  var args = Primitives.appfun(
    Primitives.between(Primitives.char("("))(Primitives.char(")"))(
      Primitives.seq(ws)(
        Primitives.seq(expr)(Primitives.many(argWithComma))
      )
    )
  )((result) => {
  ...
  var parameters = Primitives.appfun(
    Primitives.seq(
      Primitives.between(Primitives.char("("))(Primitives.char(")"))(
        Primitives.seq(param)(Primitives.many(paramWithComma))
      )
    )(ws)
  )((value) => {
  ...
  var cellRef = Primitives.appfun(
    Primitives.seq(colLetter)(rowNumber)
  )(([col, row]) => ({
    col: col.map((c) => c.toString()).join("").toUpperCase(),
    row: parseInt(row.map((d) => d.toString()).join(""), 10)
  }));
  var fixClause = Primitives.appfun(
    Primitives.seq(Primitives.ws)(
      Primitives.seq(Primitives.str("at"))(
        Primitives.seq(Primitives.ws1)(cellRef)
      )
    )
  )(([_, [__, [___, cell]]]) => cell);
  ...
  var defStmt = Primitives.appfun(
    Primitives.seq(defBinding)(
      Primitives.seq(semicolon)(ws)
    )
  )(([expr2, _]) => expr2);
